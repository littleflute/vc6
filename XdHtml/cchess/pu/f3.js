...
"use strict";
  ...
  function _UIClass(){  
    ...
    this.blrRestart1	= function(b,d)
    { 
		_cchessBoard.computer = -1;
		_cchessBoard.restart(STARTUP_FEN[0]);
    }
    this.blrRestart2	= function(b,d)
    { 
		_cchessBoard.computer = -1;
		_cchessBoard.restart(STARTUP_FEN[1]);
    }
    this.blrRestart3	= function(b,d)
    { 
		_cchessBoard.computer = -1;
		_cchessBoard.restart(STARTUP_FEN[2]);
    }
    this.blrRestart4	= function(b,d)
    { 
		_cchessBoard.computer = -1;
		_cchessBoard.restart(STARTUP_FEN[3]);
    }
